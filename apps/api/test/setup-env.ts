...
process.env.WECHAT_TEMPLATE_GLUCOSE_FIELDS ??= 'date1,thing2,thing3';
process.env.WECHAT_TEMPLATE_BP_REMINDER ??= 'test-bp-reminder-template';
process.env.WECHAT_TEMPLATE_BP_FIELDS ??= 'time4,thing2';
...
process.env.WECHAT_TEMPLATE_MEDICATION_FIELDS ??= 'time1,thing5,thing3';
